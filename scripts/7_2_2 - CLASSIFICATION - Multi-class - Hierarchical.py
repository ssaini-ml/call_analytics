...
HIERARCHICAL_CLASSIFIER = "lcpn" # "lcpn" (Local Classifier per Node) or "lcppn" (Local Classifier per Parent Node)
...
match HIERARCHICAL_CLASSIFIER:
    case "lcpn":
        model = LocalClassifierPerNode(local_classifier=svc)
    case "lcppn":
        model = LocalClassifierPerParentNode(local_classifier=svc)
